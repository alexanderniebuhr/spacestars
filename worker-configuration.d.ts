/* eslint-disable */
// Generated by Wrangler by running `wrangler types --include-runtime --include-env` (hash: fa622d896d5807e2a7bc032063c3cbcf)
// Runtime types generated with workerd@1.20260405.1 2026-04-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "SpaceAgent";
	}
	interface Env {
		SESSION: KVNamespace;
		AI: Ai;
		...
		ASSETS: Fetcher;
		SpaceAgent: DurableObjectNamespace<import("./src/worker").SpaceAgent>;
	}
}
